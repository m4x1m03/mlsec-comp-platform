...
**Your machine will have to restart during the install process. After you reboot it, run the second command again and it will pick up the install porcess back where it started. Do this until your terminal shows to sucess message.**
